...
C {devices/lab_wire.sym} 560 -200 0 0 {name=p10 sig_type=std_logic lab=buf}
C {sky130_stdcells/dfrtp_4.sym} 650 -200 0 0 {name=x3 VGND=VSSD VNB=VSSD VPB=VDDD VPWR=VDDD prefix=sky130_fd_sc_hd__ }
