...
C {cdac_sw.sym} 570 -450 0 0 {name=x2[0:11]}
C {cdac_sw.sym} 570 -570 0 0 {name=x3[0:11]}
...
C {devices/lab_wire.sym} 720 -610 2 0 {name=p5 sig_type=std_logic lab=swp[0:9]}
C {devices/lab_wire.sym} 420 -330 0 0 {name=p6 sig_type=std_logic lab=swp[0:9]}
C {devices/lab_wire.sym} 720 -490 2 0 {name=p7 sig_type=std_logic lab=swn[0:9]}
...
C {devices/lab_wire.sym} 420 -590 0 0 {name=p12 sig_type=std_logic lab=cf[0:9]}
C {devices/lab_wire.sym} 420 -470 0 0 {name=p13 sig_type=std_logic lab=cf[0:9]}
C {devices/lab_wire.sym} 420 -570 0 0 {name=p14 sig_type=std_logic lab=swp_in[0:9]}
C {devices/lab_wire.sym} 420 -450 0 0 {name=p15 sig_type=std_logic lab=swn_in[0:9]}
